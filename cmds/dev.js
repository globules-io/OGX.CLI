...
module.exports = (args) => {
    ...
    if(!options.hasOwnProperty('env') || options.env !== 'dev'){
        ...
        if(index){
            index = index.replace('<script type="text/javascript" src="js/lib/globules/ogx.min.js"></script>', '<script type="text/javascript" src="js/lib/globules/ogx.dev.min.js"></script>');
